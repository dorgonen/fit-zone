...
export const AboutUs = {
  ...
  // topLine: 'FitZone',
  headline: "מי אנחנו",
  description:"פיטזון הינו סטודיו מקצועי לרוכב המתמחה בתיקוני אופניים ובהתאמת אופניים לרוכב. ברשותנו מיטב המכשור החדשני ביותר להתאמות אופניים הקיים בעולם בנוסף למגוון נרחב ומקצועי של מוצרים נלווים להתאמה. נשמח לעמוד לשירותכם!",
